...
void Game::init_player_list(){
    ...
    Texture2D Text = LoadTextureFromImage(image0);
...
void Game::init_object_list(){
    ...
    Self_effect my_self = {30, -30}; //knowledge_change_rate, happiness_change_rate
    ...
    Self_effect my_self0 = {30, -30}; //knowledge_change_rate, happiness_change_rate
    ...
    Self_effect my_self1 = {30, -30}; //knowledge_change_rate, happiness_change_rate
    ...
    Self_effect my_self2 = {20, 10}; //knowledge_change_rate, happiness_change_rate
    ...
    Self_effect my_self3 = {-20, 30}; //knowledge_change_rate, happiness_change_rate
    Interaction_effect my_interaction3 = {-1, 3, 0, -2, 2, 0}; 
    object_vector[object_number] = new PKU_object("PSP", 0, Text, range3, my_self3, my_interaction3);
    object_number ++;
    ...
    Self_effect my_self4 = {-10, 30}; //knowledge_change_rate, happiness_change_rate
