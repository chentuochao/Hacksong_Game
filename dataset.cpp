...
void Game::init_object_list(){
    ...
    Texture2D Text = LoadTextureFromImage(image1);
    ...
    Texture2D Text = LoadTextureFromImage(image2);
    ...
    Texture2D Text = LoadTextureFromImage(image3);
    ...
    Texture2D Text = LoadTextureFromImage(image4);
