...
<<<<<<< HEAD
game: game.cpp Classes.cpp myDrawGame.cpp myUpdate.cpp
=======
game: game.cpp init.cpp Classes.cpp myDrawGame.cpp myUpdate.cpp
>>>>>>> 468538e2206a58a71411df95f1f2dc117619d741
	$(CPP) -o $@ $^ $(CFLAGS)
clean:
	rm -f $(OBJS) game
